...
public class GenericKeywords extends BaseUtil {
	...
	public void openBrowser() {
		...
		if (base.property.getProperty("browser").equalsIgnoreCase("Mozilla")) {
			...
			System.setProperty("webdriver.gecko.driver", "./src/test/resources/driver/geckodriver-v0.23.0-win64.exe");
	...
	public boolean verifyPartialText(String object, String data) {
		...
		//changed to consistent case - lower case
		String expected = data.trim().toLowerCase();
		//changed to consistent case - lower case
		String actual = getElement(object).getText().trim().toLowerCase();
